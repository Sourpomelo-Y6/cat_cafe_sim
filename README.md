...
営業前の「出勤・休養…」で担当可能な猫を設定できます。前日の接客量を基準にした出勤時の予測疲労・発症確率と、休養時の予測を比較できます。接客で増える疲労と休養日の回復を記録し、翌日の体力全回復は維持します。[出勤・休養と長期疲労](Docs/HumanToCatCafeShifts.md)を参照してください。
