...
[ゲーム全体の流れと実装順](Docs/HumanToCatGameFlowPlan.md)に、現行の遊び方・不足する経営要素・未決定事項と、次の実装順の提案を整理しています。派遣・イベント・終了判定を含む一日の流れへ更新し、[猫の詳細画面](Docs/HumanToCatCatDetailsPlan.md)の初回実装まで進めています。
